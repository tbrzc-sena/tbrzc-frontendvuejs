    ...
    <main>
      <div class="flex w-full justify-center">
        <div class="my-10 flex items-center px-6">
          <div class="flex h-full items-center rounded-lg bg-white shadow-md md:rounded-l-lg md:rounded-r-none">
            <div class="m-5 h-min">
              <h1 class="text-xl font-semibold">Bienvenido de nuevo</h1>
              <small class="">Por favor ingrese sus datos</small>
              <form class="mt-4" @submit.prevent="login()">
                <div class="mb-3 flex">
                  <input id="login-email" type="email" placeholder="Email" class="block w-full rounded-md"
                    v-model="email" />
                </div>
                <div class="mb-3 flex">
                  <input type="password" placeholder="Contraseña" class="block w-full rounded-md border"
                    v-model="password" />
                </div>
                <div class="mb-3 flex items-center">
                  ...
                  <RouterLink :to="{ name: 'forgotpassword' }" class="mx-2">Olvido su contraseña?</RouterLink>
                </div>
                <div class="mb-3">
              ...
              <div class="text-center">
                ...
                <RouterLink :to="{ name: 'registerview' }">Registrarse</RouterLink>
              </div>
            </div>
          </div>
